...
Training Script dengan Evaluasi Lengkap (Stable & Reproducible)
...
# Drop Name column if exists (tidak diperlukan untuk prediksi)
...
# Split data (80% train, 20% test) dengan stratify dan random_state
...
# ==================== 6. BUILD IMPROVED MLP MODEL ====================
print("\n" + "=" * 60)
print("STEP 6: BUILD IMPROVED MLP MODEL (STABLE & OPTIMIZED)")
print("=" * 60)

# Arsitektur MLP dengan BatchNormalization dan L2 Regularization
input_dim = X_train_scaled.shape[1]

model = keras.Sequential([
    # Input Layer
    layers.Dense(128, activation='relu', kernel_regularizer=regularizers.l2(0.001), input_shape=(input_dim,)),
...
# Compile model dengan learning rate yang lebih kecil untuk stabilitas
model.compile(
...
# ==================== 7. TRAIN MODEL ====================
print("\n" + "=" * 60)
print("STEP 7: TRAIN MODEL WITH CALLBACKS")
print("=" * 60)
...
# Training dengan batch size lebih kecil untuk stabilitas
history = model.fit(
    X_train_scaled, y_train_cat,
    validation_split=0.2,
    epochs=150,
    batch_size=16,  # Lebih kecil untuk stabilitas
...
for i in range(num_classes):
    ...
    if 'Stunting' in class_name or 'Underweight' in class_name:
...
# Save model (format yang sama dengan code asli)
...
print(f"\n🎯 Model stabil dan reproducible dengan SEED = {SEED}")